    ...
    <View style={styles.screen}>
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.card}>
          <Text style={[styles.titleBig, { color: "#22c55e" }]}>Német 8. osztály</Text>
